function enviarSolicitud(accion: string, datos: any, callback: (respuesta: string) => void) {
...
function agregarAlumno() {
    ...
    const fotoInput = (<HTMLInputElement>document.getElementById("foto")) as HTMLInputElement;
...
function verificarAlumno(legajo: string) {
    const datos = {
        accion: 'verificar',
        legajo
    };
...
function modificarAlumno(legajo: string, nombre: string, apellido: string) {
    const datos = {
        accion: 'modificar',
        legajo,
        nombre,
...
function borrarAlumno(legajo: string) {
    const datos = {
        accion: 'borrar',
        legajo
    };
